...
public class RepoCustomer implements IRepoCustomer {
    ...
    //    private static final String SELECT = "call khach_hang()";
    ...
    public void add(Customer customer) {
        ...
        try {
            ...
            preparedStatement.setInt(1, customer.getCustomer().getCategory());
    ...
    public List<Customer> findAll() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                CategoryCustomer category = iCategoryRepository.findCategoryById(customerTypeId);
                Customer customer = new Customer(id,customerTypeId, customerName, customerBirthday, customerGender, customerIdCard, customerPhone, customerEmail, customerAddress, category);
