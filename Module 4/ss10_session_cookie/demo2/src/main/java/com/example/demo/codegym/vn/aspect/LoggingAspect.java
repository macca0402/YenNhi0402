package com.example.demo.codegym.vn.aspect;
...
public class LoggingAspect {
    ...
    @Pointcut("execution (* com.example.demo.codegym.vn.service.ProductService.*(..))")
    ...
    @Around("execution (* com.example.demo.codegym.vn.service.ProductService.find*(..))")
