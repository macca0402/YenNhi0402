...
//    }
    ...
    public DriverManagerDataSource getDataSource() {
        ...
        datasource.setUrl("jdbc:mysql://localhost:3306/image_2?createDatabaseIfNotExist=true&useSSL=false&useUnicode=true&characterEncoding=utf8");
        datasource.setUsername("root");
        datasource.setPassword("0905775514");
        return datasource;
    }
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        entityManagerFactory.setPackagesToScan(new String[]{"org.example.entity"});
